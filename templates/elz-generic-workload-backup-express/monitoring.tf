...
locals {
  ...
  workload_critical_topic = {
    topic_name            = "${local.environment_prefix}-${local.workload_prefix}-Critical"
    topic_description     = "OCI Landing Zone Critical Workload Topic"
    subscription_protocol = "EMAIL"
  }
  workload_warning_topic = {
    topic_name            = "${local.environment_prefix}-${local.workload_prefix}-Warning"
  ...
  workload_alarms = {
    ...
    workload_alarms_critical_map = {
      compute_instance_status_alarm = {
        ...
        metric_compartment_id = local.workload_compartment_id
