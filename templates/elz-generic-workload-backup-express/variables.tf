...
variable "workload_developer_group_name" {
  type        = string
  description = "the name of workload developer group"
  default     = ""
}
...
variable "workload_private_spoke_subnet_SUB001_cidr_block" {
  ...
  validation {
    condition     = can(cidrhost(var.workload_private_spoke_subnet_SUB001_cidr_block, 0))
    error_message = "Must be valid IPv4 CIDR."
  }
}

variable "workload_private_spoke_subnet_SUB002_cidr_block" {
  type        = string
  description = "Workload Enivornment Spoke VCN CIDR Block."
  validation {
    condition     = can(cidrhost(var.workload_private_spoke_subnet_SUB002_cidr_block, 0))
    error_message = "Must be valid IPv4 CIDR."
  }
}

variable "workload_private_spoke_subnet_SUB003_cidr_block" {
  type        = string
  description = "Workload Enivornment Spoke VCN CIDR Block."
  validation {
    condition     = can(cidrhost(var.workload_private_spoke_subnet_SUB003_cidr_block, 0))
    error_message = "Must be valid IPv4 CIDR."
  }
}
...
variable "workload_private_spoke_subnet_SUB001_display_name" {
  type        = string
  description = "Workload Expansion Spoke Web Subnet Display Name."
  default     = ""
}

variable "workload_private_spoke_subnet_SUB002_display_name" {
  type        = string
  description = "Workload Expansion Spoke App Subnet Display Name."
  default     = ""
}

variable "workload_private_spoke_subnet_SUB003_display_name" {
  type        = string
...
variable "hub_vcn_cidr_block" {
  ...
  default = "10.0.0.0/16"
  validation {
    condition     = can(cidrhost(var.hub_vcn_cidr_block, 0))
    error_message = "Must be valid IPv4 CIDR."
  }
}
...
variable "lzexpress_baseline_backup_orm_stack_id" {
  type        = string
  description = "the OCID of the lzexpress basline ORM stack"
}
